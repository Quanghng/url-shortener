...
Use:   "url-shortener",
Short: "service pour raccourcir les URLs avec API REST et CLI",
Long: `'url-shortener' est une app complète pour gérer des URLs courtes.
Elle comprend notamment un serveur API pour le raccourcissement et la redirection,
et une interface en ligne de commande pour l'administration.
...
func init() {
// Initialise la configuration globale avant chaque commande
